Function Get-ExpirableVerintExpressMembers {
	...
	$ExpirableUsers = Get-ADUser -SearchBase "CN=Users,DC=my-org,DC=com" -Filter { Enabled -eq $True -and PasswordNeverExpires -eq $False } -Properties "DisplayName", "msDS-UserPasswordExpiryTimeComputed"
...
<#
$AdminCredential = New-Object System.Management.Automation.PSCredential ("MY-DOMAIN\admin", (ConvertTo-SecureString 'My-s3cUre_P4sswOrd' -AsPlainText -Force))
